...
public class Turret : MonoBehaviour
{
    ...
    private void SpawnProjectile()
    {
        ...
        {
            Projectile projectile = Instantiate(projectilePrefab, new Vector3 
                (startPosX + i * projectileInterval, shootPoint.position.y, shootPoint.position.z), transform.rotation);
